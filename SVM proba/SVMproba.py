...
class SVM:
    ...
    def train_and_test(self, k = 0):
        ...
        if k < 3:
            ...
            self.classifier = nltk.SklearnClassifier(svm.SVC(C=1.0, cache_size=200, class_weight=None, coef0=0.0, degree=2,gamma=0.3, kernel='rbf', max_iter=-1, probability=False, random_state=None,shrinking=True, tol=0.0001, verbose=False)).train(train_set)#degree=2, gamma=0.3, tol=0.0001 (prije bio 0.001) najbolji rezovi
